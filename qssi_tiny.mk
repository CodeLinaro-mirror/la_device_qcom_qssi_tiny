...
VENDOR_QTI_PLATFORM := qssi_tiny
VENDOR_QTI_DEVICE := qssi_tiny
...
$(call inherit-product, device/qcom/qssi_tiny/common64.mk)
...
TARGET_SYSTEM_PROP += device/qcom/qssi_tiny/system.prop
...
DEVICE_FRAMEWORK_MANIFEST_FILE := device/qcom/qssi_tiny/framework_manifest.xml
...
PRODUCT_COPY_FILES += \
    device/qcom/qssi_tiny/init.qcom.testscripts.sh:$(TARGET_COPY_OUT_PRODUCT)/etc/init.qcom.testscripts.sh
endif

PRODUCT_COPY_FILES += \
    device/qcom/qssi_tiny/public.libraries.product-qti.txt:$(TARGET_COPY_OUT_PRODUCT)/etc/public.libraries-qti.txt

# copy system_ext specific whitelisted libraries to system_ext/etc
PRODUCT_COPY_FILES += \
    device/qcom/qssi_tiny/public.libraries.system_ext-qti.txt:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/public.libraries-qti.txt
