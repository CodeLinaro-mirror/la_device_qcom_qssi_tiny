...
FAILED_FILEPATHS_WHITELIST = {
    ...
    "vendor/qcom/proprietary/prebuilt_ASAN/target/product/qssi_tiny/prebuilt.mk",
    ...
    "vendor/qcom/proprietary/prebuilt_grease/target/product/qssi_tiny/prebuilt.mk",
    ...
    "vendor/qcom/proprietary/prebuilt_HY11/target/product/qssi_tiny/prebuilt.mk",
    ...
    "vendor/qcom/proprietary/prebuilt_HY22/target/product/qssi_tiny/prebuilt.mk",
...
OVERRIDE_WHITELIST = {
    "device/qcom/qssi_tiny/qssi_tiny.mk",
    "device/qcom/qssi_tiny/qssi_tiny_whitelist.mk",
}

SOONG_WHITELIST = {
    "device/qcom/qssi_tiny/base.mk",
    "vendor/qcom/opensource/commonsys/display/config/display-product-commonsys.mk",
